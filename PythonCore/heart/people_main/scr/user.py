from PythonCore.heart.people_main.scr.old import User
from PythonCore.heart.people_main.scr.dead import heart_failure
from PythonCore.heart.people_main.scr.start import *
from PythonCore.heart.people_main.scr.deastole import *
